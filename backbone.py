...
class MultiLayerPerceptron(torch.nn.Module):
    def __init__(self, seed, input_size, num_classes, num_layers, channels, learning_rate, batch_size, epochs, patience,
                 weight_decay):
        ...
        # self.weight = nn.Parameter(torch.empty(20530))
...
def MLP10():
    return MultiLayerPerceptron(0,9070,3,2,[128,64],0.0001,50,250,10,0.0)
